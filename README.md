...
```javascript
maxsorted = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/stats-strided-maxsorted@umd/browser.js' )
```
The previous example will load the latest bundled code from the umd branch. Alternatively, you may load a specific version by loading the file from one of the [tagged bundles](https://github.com/stdlib-js/stats-strided-maxsorted/tags). For example,

```javascript
maxsorted = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/stats-strided-maxsorted@v0.1.1-umd/browser.js' )
```

To vendor stdlib functionality and avoid installing dependency trees for Node.js, you can use the UMD server build:

```javascript
var maxsorted = require( 'path/to/vendor/umd/stats-strided-maxsorted/index.js' )
```

To include the bundle in a webpage,

```html
<script type="text/javascript" src="https://cdn.jsdelivr.net/gh/stdlib-js/stats-strided-maxsorted@umd/browser.js"></script>
```
...
[npm-image]: http://img.shields.io/npm/v/@stdlib/stats-strided-maxsorted.svg
[npm-url]: https://npmjs.org/package/@stdlib/stats-strided-maxsorted

[test-image]: https://github.com/stdlib-js/stats-strided-maxsorted/actions/workflows/test.yml/badge.svg?branch=v0.1.1
[test-url]: https://github.com/stdlib-js/stats-strided-maxsorted/actions/workflows/test.yml?query=branch:v0.1.1

[coverage-image]: https://img.shields.io/codecov/c/github/stdlib-js/stats-strided-maxsorted/main.svg
[coverage-url]: https://codecov.io/github/stdlib-js/stats-strided-maxsorted?branch=main

<!--

[dependencies-image]: https://img.shields.io/david/stdlib-js/stats-strided-maxsorted.svg
[dependencies-url]: https://david-dm.org/stdlib-js/stats-strided-maxsorted/main
...
[deno-url]: https://github.com/stdlib-js/stats-strided-maxsorted/tree/deno
[deno-readme]: https://github.com/stdlib-js/stats-strided-maxsorted/blob/deno/README.md
[umd-url]: https://github.com/stdlib-js/stats-strided-maxsorted/tree/umd
[umd-readme]: https://github.com/stdlib-js/stats-strided-maxsorted/blob/umd/README.md
[esm-url]: https://github.com/stdlib-js/stats-strided-maxsorted/tree/esm
[esm-readme]: https://github.com/stdlib-js/stats-strided-maxsorted/blob/esm/README.md
[branches-url]: https://github.com/stdlib-js/stats-strided-maxsorted/blob/main/branches.md

[stdlib-license]: https://raw.githubusercontent.com/stdlib-js/stats-strided-maxsorted/main/LICENSE
